...
export default function LandingPage() {
  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen p-8">
      ...
      <Link href="/start">
        <button
          className={`w-80 px-6 ${buttonSize} bg-blue-500 text-white rounded-md hover:bg-blue-600 mb-4`}
        >
          기능 시작하기
        </button>
      </Link>
      ...
      {showInstall && (
        <button
          ...
          className={`w-80 px-6 ${buttonSize} bg-green-600 text-white rounded-md hover:bg-green-700`}
        >
          앱 설치하기
        </button>
      )}
